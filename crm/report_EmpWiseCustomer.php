...
<html lang="en">
    <head>
        ...
        <title>Employee Wise Customer</title>
    ...
    <body>
                                ...
                                <div class="table-responsive">';                                    
                                    if (isset($_POST['submit'])) {
                                        if($_POST['emp_name'] == '0'){
                                            ...
                                            $query = "SELECT * FROM `msd_register_customer_table` WHERE `reference_id` = '".$_POST['emp_name']."' AND `register_status` != 2";
                                        }
                                    }  else { 
                                        $query = "SELECT * FROM `msd_register_customer_table` WHERE `register_status` != 2";
                                    }
                                    ...
                                    if ($result = $conn->query($query)) {
                                                ...
                                                echo'<tr>
                                                        ...
                                                        <td>'.$row["register_fname"].'  '.$row["register_mname"].' '.$row["register_lname"].'</td>
                                                        <td>'.$row["register_activate_status"].'</td>
                                                    </tr>';
        ...
        <script>
            ...
            function ExportExcel(type, fn, dl) {
                ...
                XLSX.writeFile(wb, fn || ('Employee_Wise Customer_Report.' + (type || 'xlsx')));
            }

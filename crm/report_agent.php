                            ...
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Partner Details</h5>
                                        ...
                                        <?php
                                              $query = "SELECT * FROM msd_register_comp_agent_table WHERE agent_id = '".$_SESSION["USERID"]."' AND status!= 2";
                                              $i = 0;
                            ...
                            <div class="tab-pane tabs-animation fade" id="tab-content-1" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Customer Details</h5>
                                        ...
                                        <div class="table-responsive">
                                        <?php
                                              $query = "SELECT * FROM `msd_register_customer_table` WHERE agent_id = '".$_SESSION["USERID"]."' AND register_status != 2";
                                              $i = 0;
                                              echo '<table class="mb-0 table table-bordered">
                                              <thead>
                                              <tr>

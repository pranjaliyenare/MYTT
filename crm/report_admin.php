                ...
                <div class="app-main__outer">
                    ...
                    <?php if($_SESSION["ROLE"] == "admin" || $_SESSION["ROLE"] == "accountant") { ?>
                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Manager Details</h5>
                                        <form class="">
                                        <div class="table-responsive">
                                        <!-- <div class="row">
                                            <div class="col-lg-6">
                                                <div class="main-card mb-3 card">
                                                    <div class="card-body"><h5 class="card-title">Manager table</h5> -->
                            ...
                            <div class="tab-pane tabs-animation fade" id="tab-content-3" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Customer Details</h5>
                                        ...
                                        <div class="table-responsive">
                                        <?php
                                              $query = "SELECT * FROM `msd_register_customer_table` WHERE  `register_activate_status` = 'activate' AND  register_status != 2";
                                              $i = 0;
                                              echo '<table class="mb-0 table table-bordered">
                                              <thead>
                                              <tr>

        ...
        <div class="app-main__inner">
            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <form class="" method="post" action="transaction_withdraw_db">
                    <div class="row">                        
                        <div class="col-md-6">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">MEMBER DETAILS</h5>
                                    ...
                                    $query = mysqli_query($conn, "SELECT * FROM `msd_register_comp_agent_table` WHERE `agent_id` = '".$agentid."' AND `status` != 2");
                                        ...
                                        ?>
                                    <div class="position-relative row form-group div_id_class" style="display: none;"><label for="id" class="col-sm-3 col-form-label">Id</label>
                                        <div class="col-sm-9"><input name="id" id="id" class="form-control border-0" value="<?php echo $agentid; ?>"></div>
                                    </div>
                               ...
                               <!-- <form class=""> -->
                                        <?php
                                         $query = mysqli_query($conn, "SELECT * FROM `msd_user_bankdtl_table` WHERE `ACCOUNT_HOLDER_NAME` = '".$agentid."' and `STATUS` != 2");
                                            ...
                                            $my_id_array=mysqli_fetch_assoc($query);
                                            if($my_id_array>0 || $agentid != NULL && !empty($my_id_array)) {
                                                ...
                                                echo "<script>window.location = 'master_agent_bankdtl?id=".base64_encode($agentid)."';</script>";
                                            }
                                        ?>
                                        <div class="position-relative row form-group div_bankname_class" ><label for="bankname_id" class="col-sm-4 col-form-label">Bank Name</label>
                                            <div class="col-sm-8">
                                                ...
                                                <label name="bankname_name" id="bankname_id" type="text" class="form-control border-0" ><?php echo $bankname ?></label></div>
                                        </div>

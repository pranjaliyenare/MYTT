                ...
                <div class="page-title-wrapper">
                    ...
                    <div class="page-title-actions">
                        ...
                        <?php //if($_SESSION['ROLE'] == 'admin'){
                          //  echo '<button type="button" class="btn mr-2 mb-2 btn-primary" data-toggle="modal" data-target="#exampleModal">Add New QR Code</button>';
                        //}
                        ?>
                ...
                <div class="col-lg-12">
                    <div class="main-card mb-3 card">
                        ...
                        <form class="" method="post">
                                <div class="position-relative row form-group div_QR_class" >
                                    <div class="col-sm-9"><img src="assets/images/QRCode.jpeg" name="QR_name" id="QR_id" class="bank_class" style="width: 100%; height: 100%;"/>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New QR Code</h5>

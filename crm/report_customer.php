...
<div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <?php 
                            $sql = mysqli_query($conn, "SELECT * FROM `msd_register_customer_table` WHERE `register_id` = '".$id."' AND `register_approved_status` = 'approved' AND `register_status` != 2");
                            ...
                            $sql1 = mysqli_query($conn, "SELECT * FROM `msd_customer_plan_table` WHERE `customer_id` = '".$id."' AND `status` != 2");
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane tabs-animation fade" id="tab-content-1" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    ...
                                    <form class="">
                                    <?php
                                         $query = mysqli_query($conn, "SELECT * FROM `msd_user_bankdtl_table` WHERE `ACCOUNT_HOLDER_NAME` = '".$id."' and `STATUS` != 2");
                            ...
                            <div class="tab-pane tabs-animation fade" id="tab-content-2" role="tabpanel">
                                <div class="main-card mb-3">
                                    ...
                                    <?php } ?>
                                        <form class="">
                                            <?php
                                                $query = mysqli_query($conn, "SELECT * FROM `msd_user_kyc_table` WHERE `USER_ID` = '".$id."' AND `STATUS` != 2");

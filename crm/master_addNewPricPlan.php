...
<?php include 'header.php'; 
    ...
    if(isset($_POST['btnAdd'])) {          
      ...
      echo  $planid = 'PLAN'.$my_id; 
        ...
        if (isset($planid)){          
          // Insert Value
          $sql = "INSERT INTO `msd_plan_table`(`plan_id`, `plan_name`, `plan_profit_perc`, `plan_principle_perc`, `plan_duration`, `pric_duration`,`prof_duration`, `plan_min_criteria`, `plan_max_criteria`, `plan_payout`, `plan_add_profit`, `return_type`) VALUES ('".$planid."','".$_POST['plan_name']."','".$_POST['prof_perc']."','".$_POST['prin_perc']."','".$_POST['tot_duration']."','".$_POST['pric_duration']."','".$_POST['prof_duration']."','".$_POST['min_amt']."','".$_POST['max_amt']."','".$_POST['payout']."','".$_POST['profit']."', 'capital')";
        }
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Add New Principle Plan</div>
                            </div>
                        </div>
                    </div>           
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <form method="POST" action="master_addNewPricPlan.php">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="duration_id">Total Duration</label>
                                        <input type="text" class="form-control tot_duration_class" id="tot_duration_id" name="tot_duration" placeholder="Plan Total Duration" required="">
                                    </div>                                                               
                                </div>
                                <div class="form-row">
                                    <div class="col-md-3 mb-3">
                                        <label for="prin_perc">Principal Percentage</label>
                                        <input type="text" class="form-control pric_perc_class" id="prin_perc_id" name="prin_perc" placeholder="Principal Percentage" required="">
                                    </div>  
                                    <div class="col-md-3 mb-3">
                                        <label for="pric_duration_id">Principal Duration</label>
                                        <input type="text" class="form-control pric_duration_class" id="pric_duration_id" name="pric_duration" placeholder="Principal Duration" required="">
                                    </div>  
                                    <div class="col-md-3 mb-3">
                                        <label for="prof_perc">Profit Percentage</label>
                                        <input type="text" class="form-control prof_perc_class" id="prof_perc_id" name="prof_perc" placeholder="Profit Percentage" required="">
                                        
                                    </div>  
                                    <div class="col-md-3 mb-3">
                                        <label for="prof_duration_id">Profit Duration</label>
                                        <input type="text" class="form-control prof_duration_class" id="prof_duration_id" name="prof_duration" placeholder="Profit Duration" required="">
                                    </div>                                        
                                </div>
                                <div class="form-row">                         
                                    <div class="col-md-3 mb-3">

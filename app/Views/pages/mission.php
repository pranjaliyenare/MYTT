              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="title" id="title" value="<?php echo $title;?>" placeholder="Title of Mission" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" name="content" class="form-control" id="content" placeholder="Content for Mission" required><?php echo $content;?> </textarea>
                    </div>
